...
{ 
	...
	{
		std::cout << "Texture and shaders already loaded so using those one" << std::endl;
	...
	{
		std::cout << "Shaders already loaded so using same ones. But making new texture" << std::endl;
