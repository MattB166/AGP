...
const wchar_t* windowName = L"Week 2 Window Creation with D3D11"; // Name of our window
...
///value to pass a status code onto another program that is waiting for the completion of this program 
{
	...
	OpenConsole();  ///Open a console window for debugging purposes
	...
	{
		MessageBox(NULL, L"Direct3D Initialization Failed!", L"Error!", MB_ICONERROR | MB_OK);
	}
	...
	CleanD3D();  ///Clean up Direct3D resources
